...
#include "err/sys/categ/Generic.h"
...
typedef basic::err::sys::categ::Generic CategoryTraitType;
...
public:
        ...
        VariableTestCategoryGeneric & var)
    {
        typedef typename basic::test::var::Element<ICodeHasEnumType,
            VariableTestCategoryGeneric>::Type CodeHasEnumType;
        ...
        VariableTestCategoryGeneric & var)
    {
        typedef typename basic::test::var::Element<ICondHasEnumType,
            VariableTestCategoryGeneric>::Type CondHasEnumType;
        ...
        VariableTestCategoryGeneric & var)
    {
        typedef typename basic::test::var::Element<IMakeVoidCategoryType,
            VariableTestCategoryGeneric>::Type VoidCategoryType;
        ...
        VariableTestCategoryGeneric & var)
    {
        typedef typename basic::test::var::Element<IMakeCodeCategoryType,
            VariableTestCategoryGeneric>::Type CodeCategoryType;
        auto * result = basic::test::var::At<IMakeCategoryValue>(var).Get().
            Get();
        ...
        VariableTestCategoryGeneric & var)
    {
        typedef typename basic::test::var::Element<IMakeConditionCategoryType,
            VariableTestCategoryGeneric>::Type ConditionCategoryType;
        auto * result = basic::test::var::At<IMakeCategoryValue>(var).Get().
            Get();
        ...
        VariableTestCategoryGeneric & var)
    {
        typedef typename basic::test::var::Element<IMakeCodeType,
            VariableTestCategoryGeneric>::Type CodeType;
        ...
        VariableTestCategoryGeneric & var)
    {
        typedef typename basic::test::var::Element<IMakeConditionType,
            VariableTestCategoryGeneric>::Type ConditionType;
...
CategoryValueType categ_val{basic::defn::err::sys::generic_category};
...
T1Var1 t1_var1{
    ...
    static_cast<CodeValueType>(std::errc::interrupted),
    static_cast<ConditionValueType>(std::errc::operation_would_block)};
...
BASIC_TEST_TYPE_NAME("basic::err::sys::categ::Generic",
    basic::err::sys::categ::Generic);
