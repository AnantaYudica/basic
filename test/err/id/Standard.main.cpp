...
public:
    ...
    {
        return typeid(typename basic::err::id::Standard::CodeValueType).
        ...
        VariableTestIdStandard<TObj> & var)
    {
        ...
        const auto & id = *basic::test::var::At<IIdentificationValue>(var).
            Get().Get();
        const bool check_err = id_standard.IsSystem() ? true :
            (id_standard.Error().Code() == id.Error().Code());
        const bool check_err_sys = !id_standard.IsSystem() ? true :
...
BASIC_TEST_TYPE_NAME("basic::err::id::Standard", basic::err::id::Standard);
BASIC_TEST_TYPE_NAME("basic::err::Identification", 
    basic::err::Identification);

typedef VariableTestIdStandard<basic::err::id::Standard> T1Var1;

constexpr typename basic::err::id::Standard::CodeValueType code_value1 = 4;

basic::err::id::Standard obj1_1;
basic::err::id::Standard obj1_2{code_value1};

basic::err::Identification id1_1;
basic::err::Identification id1_2{basic::err::id::flag::Standard{}, 
    code_value1};
...
basic::err::id::Standard obj2_1{obj1_1};
basic::err::id::Standard obj2_2{obj1_2};
...
basic::err::id::Standard obj2_1_c{obj2_1};
basic::err::id::Standard obj2_2_c{obj2_2};

basic::err::id::Standard obj3_1{std::move(obj2_1_c)};
basic::err::id::Standard obj3_2{std::move(obj2_2_c)};
