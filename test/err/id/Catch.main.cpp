...
public:
    ...
    {
        return typeid(typename basic::err::id::Catch::CodeValueType).
            hash_code() == typeid(basic::err::defn::type::code::Value).
            hash_code();
    }
    template<typename TObj>
    bool Result(const TestAliasSystemCategoryValueType &, 
        VariableTestIdCatch<TObj> & var)
    {
        return typeid(typename basic::err::id::Catch::
        ...
        VariableTestIdCatch<TObj> & var)
    {
        ...
        const auto & id = *basic::test::var::At<IIdentificationValue>(var).
            Get().Get();
        const bool check_err = id_catch.IsSystem() ? true :
            (id_catch.Error().Code() == id.Error().Code());
        const bool check_err_sys = !id_catch.IsSystem() ? true :
...
BASIC_TEST_TYPE_NAME("basic::err::id::Catch", basic::err::id::Catch);
BASIC_TEST_TYPE_NAME("basic::err::Identification", 
    basic::err::Identification);

typedef VariableTestIdCatch<basic::err::id::Catch> T1Var1;

constexpr typename basic::err::id::Catch::CodeValueType code_value1 = 4;
constexpr typename basic::err::id::Catch::SystemCategoryValueType
    categ_value1 = 0xB;

basic::err::id::Catch obj1_1;
basic::err::id::Catch obj1_2{code_value1};
basic::err::id::Catch obj1_3{basic::err::id::flag::Standard{}, 
    code_value1};
basic::err::id::Catch obj1_4{basic::err::id::flag::System{},
    categ_value1, code_value1};
basic::err::id::Catch obj1_5{basic::err::id::flag::System{},
    basic::err::id::flag::Standard{}, categ_value1, code_value1};

basic::err::Identification id1_1;
basic::err::Identification id1_2{basic::err::id::flag::Catch{},
    code_value1};
basic::err::Identification id1_3{basic::err::id::flag::Catch{},
    basic::err::id::flag::Standard{}, code_value1};
basic::err::Identification id1_4{basic::err::id::flag::Catch{},
    basic::err::id::flag::System{}, categ_value1, code_value1};
basic::err::Identification id1_5{basic::err::id::flag::Catch{},
...
basic::err::Identification id2_2{code_value1};
basic::err::Identification id2_3{basic::err::id::flag::Standard{}, 
    code_value1};
basic::err::Identification id2_4{basic::err::id::flag::System{}, 
    categ_value1, code_value1};
basic::err::Identification id2_5{basic::err::id::flag::System{}, 
    basic::err::id::flag::Standard{}, categ_value1, code_value1};

basic::err::Identification id2_0{basic::err::id::flag::Catch{},
    basic::err::Identification{}};

basic::err::id::Catch obj2_1{id2_1};
basic::err::id::Catch obj2_2{id2_2};
basic::err::id::Catch obj2_3{id2_3};
basic::err::id::Catch obj2_4{id2_4};
basic::err::id::Catch obj2_5{id2_5};
...
basic::err::Identification id3_1;
basic::err::Identification id3_2{code_value1};
basic::err::Identification id3_3{basic::err::id::flag::System{}, 
    categ_value1, code_value1};

basic::err::Identification id3_0{basic::err::id::flag::Catch{},
    basic::err::id::flag::Standard{}, basic::err::Identification{}};

basic::err::id::Catch obj3_1{basic::err::id::flag::Standard{}, id3_1};
basic::err::id::Catch obj3_2{basic::err::id::flag::Standard{}, id3_2};
basic::err::id::Catch obj3_3{basic::err::id::flag::Standard{}, id3_3};
...
basic::err::id::Catch obj4_1{obj2_1};
basic::err::id::Catch obj4_2{obj3_1};
basic::err::id::Catch obj4_3{obj1_1};
basic::err::id::Catch obj4_4{obj1_2};
basic::err::id::Catch obj4_5{obj1_3};
basic::err::id::Catch obj4_6{obj1_4};
basic::err::id::Catch obj4_7{obj1_5};
...
basic::err::id::Catch obj4_1_c{obj4_1};
basic::err::id::Catch obj4_2_c{obj4_2};
basic::err::id::Catch obj4_3_c{obj4_3};
basic::err::id::Catch obj4_4_c{obj4_4};
basic::err::id::Catch obj4_5_c{obj4_5};
basic::err::id::Catch obj4_6_c{obj4_6};
basic::err::id::Catch obj4_7_c{obj4_7};

basic::err::id::Catch obj5_1{std::move(obj4_1_c)};
basic::err::id::Catch obj5_2{std::move(obj4_2_c)};
basic::err::id::Catch obj5_3{std::move(obj4_3_c)};
basic::err::id::Catch obj5_4{std::move(obj4_4_c)};
basic::err::id::Catch obj5_5{std::move(obj4_5_c)};
basic::err::id::Catch obj5_6{std::move(obj4_6_c)};
basic::err::id::Catch obj5_7{std::move(obj4_7_c)};
