...
#include "err/Definition.h"

#include "err/id/Record.h"
#include "err/defn/type/Char.h"
#include "err/defn/type/Output.h"
#include "err/defn/type/code/Value.h"
#include "err/defn/type/id/Record.h"
#include "err/defn/type/msg/str/Storage.h"
#include "err/defn/type/output/Char.h"
#include "err/defn/type/output/CharTrait.h"
...
public:
            ...
            TVariables...>(*this, var...)
    {
        ...
        SetFormat(err, testIsSameType, "Error %s{%s} and %s{%s}"
            " is not same type\n");
        ...
        SetFormat(err, testSizeofAType, "Error size of %s{%s}"
            " is not %zu bytes\n");
        ...
        SetFormat(err, testCallOutputOperator, "Error call Output operator "
