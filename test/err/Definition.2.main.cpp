...
#define BASIC_ERR_OUTPUT strout

#include <vector>

typedef std::vector<char> BasicErrorMsgStrStorageType;

#define BASIC_ERR_MSG_STR_STORAGE_TYPE BasicErrorMsgStrStorageType
...
T1Var1 t1_var1{"basic::err::defn::type::Char", "BasicErrorCharType"};
...
T2Var1 t2_var1{"basic::err::defn::type::Output", 
