...
int main()
{
    ...
    basic::test::msg::Argument<Case1,
        basic::test::msg::arg::Value<0>> arg1;

    basic::test::Variable<basic::test::Value<int>> var1(VALUE1_INT);
    ...
    basic::test::Variable<basic::test::Value<int>> var2(VALUE2_INT);
    ...
    basic::test::Variable<basic::test::Value<int>> var3(VALUE3_INT);
    ...
    basic::test::Variable<basic::test::Value<int>> var4(VALUE4_INT);
    ...
    basic::test::Variable<basic::test::Value<int>> var5(VALUE3_INT);
    ...
    basic::test::Variable<basic::test::Value<int>> var6(VALUE4_INT);
    ...
    basic::test::msg::Argument<Case1,
        ...
        basic::test::msg::arg::Value<3>> arg2;
    basic::test::Variable<
        basic::test::Value<int>,
        basic::test::Value<int>,
        basic::test::Value<int>,
        basic::test::Value<int>> var7(VALUE1_INT, VALUE2_INT,
