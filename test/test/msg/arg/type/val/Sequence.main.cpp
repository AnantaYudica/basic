...
int main()
{
    ...
    basic::test::msg::Argument<Case1,
        basic::test::msg::arg::type::val::Sequence<0>> arg1;
    ...
    printf("output : \"%s\"\n", buffer);
    assert(strcmp(VALUE3_CSTR, buffer) == 0);
    assert(arg1.template Get<0>(var5) == VALUE3_INT);
    ...
    printf("output : \"%s\"\n", buffer);
    assert(strcmp(VALUE4_CSTR, buffer) == 0);
    assert(arg1.template Get<0>(var6) == VALUE4_INT);
    ...
    arg1.Call<void>(case1_index4, &TestA::Call, testa1, var7,
        std::forward<char*>(buffer),
        std::forward<const std::size_t&>(buff_size), std::move(format2));
    printf("output : \"%s\"\n", buffer);
    assert(strcmp(VALUE1_CSTR VALUE2_CSTR
    ...
    assert(arg1.template Get<0>(var7) == VALUE1_INT);
    assert(arg1.template Get<1>(var7) == VALUE2_INT);
    assert(arg1.template Get<2>(var7) == VALUE3_INT);
    assert(arg1.template Get<3>(var7) == VALUE4_INT);
    ...
    basic::test::msg::Argument<Case1,
        basic::test::msg::arg::type::val::Sequence<0>,
        basic::test::msg::arg::type::val::Sequence<1>,
        basic::test::msg::arg::type::val::Sequence<2>,
        basic::test::msg::arg::type::val::Sequence<3>> arg2;
    ...
    arg2.Call<void>(case1_index4, &TestA::Call, testa1, var8,
        std::forward<char*>(buffer),
        std::forward<const std::size_t&>(buff_size), std::move(format2));
    printf("output : \"%s\"\n", buffer);
    assert(strcmp(VALUE1_CSTR VALUE2_CSTR
    ...
    assert(arg2.template Get<0>(var8) == VALUE1_INT);
