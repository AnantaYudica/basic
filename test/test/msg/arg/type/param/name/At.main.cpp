...
int main()
{
    ...
    basic::test::msg::Argument<Case1,
        basic::test::msg::arg::type::param::name::At<0, 0>> arg1;
    ...
    basic::test::msg::Argument<Case1,
        basic::test::msg::arg::type::param::name::At<0, 0>> arg2;
    ...
    basic::test::msg::Argument<Case1,
        basic::test::msg::arg::type::param::name::At<0, 1>> arg3;
    arg3.Call<int>(&Call, var7, std::forward<char*>(buffer),
        std::forward<const std::size_t&>(buff_size), std::move(format1));
    printf("output : \"%s\"\n", buffer);
    assert(strcmp(SHORT_CSTR, buffer) == 0);
    assert(strcmp(*arg3.Get(var7), SHORT_CSTR) == 0);

    basic::test::msg::Argument<Case1,
        basic::test::msg::arg::type::param::name::At<0, 2>> arg4;
    arg4.Call<void>(case1_index0, &TestA::Call, testa1, var7,
        std::forward<char*>(buffer),
        std::forward<const std::size_t&>(buff_size), std::move(format1));
    printf("output : \"%s\"\n", buffer);
    assert(strcmp(INT_CSTR, buffer) == 0);
    assert(strcmp(*arg4.Get(var7), INT_CSTR) == 0);

    basic::test::msg::Argument<Case1,
        basic::test::msg::arg::type::param::name::At<0, 3>> arg5;
    arg5.Call<int>(case1_index0, &Call, var7, std::forward<char*>(buffer),
        std::forward<const std::size_t&>(buff_size), std::move(format1));
    printf("output : \"%s\"\n", buffer);
    assert(strcmp(LONG_CSTR, buffer) == 0);
    assert(strcmp(*arg5.Get(var7), LONG_CSTR) == 0);

    arg4.Call<void>(case1_index3, &TestA::Call, testa1, var7,
        std::forward<char*>(buffer),
        std::forward<const std::size_t&>(buff_size), std::move(format1));
    printf("output : \"%s\"\n", buffer);
    assert(strcmp(INT_CSTR, buffer) == 0);
    ...
    arg5.Call<int>(case1_index3, &Call, var7, std::forward<char*>(buffer),
        std::forward<const std::size_t&>(buff_size), std::move(format1));
    printf("output : \"%s\"\n", buffer);
    assert(strcmp(LONG_CSTR, buffer) == 0);
    assert(strcmp(*arg5.Get(var7), LONG_CSTR) == 0);
    ...
    basic::test::msg::Argument<Case1,
        basic::test::msg::arg::type::param::name::At<0, 0>,
        basic::test::msg::arg::type::param::name::At<0, 1>,
        basic::test::msg::arg::type::param::name::At<0, 2>,
        basic::test::msg::arg::type::param::name::At<0, 3>> arg6;

    const char* format2 = "%s%s%s%s";

    arg6.Call<void>(&TestA::Call, testa1, var7, std::forward<char*>(buffer),
        std::forward<const std::size_t&>(buff_size), std::move(format2));
    printf("output : \"%s\"\n", buffer);
    assert(strcmp(CHAR_CSTR SHORT_CSTR INT_CSTR LONG_CSTR, buffer) == 0);

    arg6.Call<int>(&Call, var7, std::forward<char*>(buffer),
        std::forward<const std::size_t&>(buff_size), std::move(format2));
    printf("output : \"%s\"\n", buffer);
    assert(strcmp(CHAR_CSTR SHORT_CSTR INT_CSTR LONG_CSTR, buffer) == 0);

    arg6.Call<void>(case1_index0, &TestA::Call, testa1, var7,
        std::forward<char*>(buffer),
        std::forward<const std::size_t&>(buff_size), std::move(format2));
    printf("output : \"%s\"\n", buffer);
    assert(strcmp(CHAR_CSTR SHORT_CSTR INT_CSTR LONG_CSTR, buffer) == 0);

    arg6.Call<int>(case1_index0, &Call, var7, std::forward<char*>(buffer),
        std::forward<const std::size_t&>(buff_size), std::move(format2));
    printf("output : \"%s\"\n", buffer);
    assert(strcmp(CHAR_CSTR SHORT_CSTR INT_CSTR LONG_CSTR, buffer) == 0);

    arg6.Call<void>(case1_index3, &TestA::Call, testa1, var7,
        std::forward<char*>(buffer),
        std::forward<const std::size_t&>(buff_size), std::move(format2));
    printf("output : \"%s\"\n", buffer);
    assert(strcmp(CHAR_CSTR SHORT_CSTR INT_CSTR LONG_CSTR, buffer) == 0);

    arg6.Call<int>(case1_index3, &Call, var7, std::forward<char*>(buffer),
        std::forward<const std::size_t&>(buff_size), std::move(format2));
    printf("output : \"%s\"\n", buffer);
    assert(strcmp(CHAR_CSTR SHORT_CSTR INT_CSTR LONG_CSTR, buffer) == 0);

    assert(strcmp(*arg6.Get(var7), CHAR_CSTR) == 0);
