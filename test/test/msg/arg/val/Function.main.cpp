...
int main()
{
    ...
    basic::test::msg::Argument<Case1,
        basic::test::msg::arg::val::Function<0>> arg0;

    basic::test::Variable<
        basic::test::val::Function<const char*()>> var0(&Foo0);
    ...
    basic::test::Variable<
        basic::test::val::Function<char*(const char*&&)>,
        basic::test::Value<const char*>> var1(&Foo1, cstr1);
    ...
    basic::test::Variable<
        ...
        basic::test::Value<int>,
        basic::test::Value<int>,
        basic::test::Value<int>> var2(&Foo1, cstr3, VALUE1_INT, VALUE2_INT,
