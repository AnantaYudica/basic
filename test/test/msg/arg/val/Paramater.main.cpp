...
int main()
{
    ...
    basic::test::msg::Argument<Case1,
        basic::test::msg::arg::val::Parameter<0>> arg1;
    ...
    assert(arg1.template Get<0>(var1) == VALUE1_CHAR);
    ...
    assert(arg1.template Get<0>(var2) == VALUE2_SHORT);
    ...
    assert(arg1.template Get<0>(var4) == VALUE4_LONG);
    ...
    assert(arg1.template Get<0>(var5) == VALUE1_CHAR);
    assert(arg1.template Get<1>(var5) == VALUE2_SHORT);
    assert(arg1.template Get<2>(var5) == VALUE3_INT);
    assert(arg1.template Get<3>(var5) == VALUE4_LONG);
    ...
    basic::test::msg::Argument<Case1,
        basic::test::msg::arg::val::Parameter<0>,
        basic::test::msg::arg::val::Parameter<1>,
        basic::test::msg::arg::val::Parameter<2>,
        basic::test::msg::arg::val::Parameter<3>> arg2;
    ...
    assert(arg2.template Get<0>(var6) == VALUE1_CHAR);
