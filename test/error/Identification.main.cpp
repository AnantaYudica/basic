...
basic::test::CString<char> FlagToString(basic::error::id::Flag * && flag)
{
    return basic::test::cstr::Format(BUFFER_FORMAT_CSTRING, 
        "0x%02X", reinterpret_cast<typename basic::error::id::
            Flag::ValueType &&>(*flag));
}
...
basic::test::CString<char> RecordToString(basic::error::id::
    Record<TErrorCodeValue, TErrorSystemCategoryValue, 
        TErrorSystemCodeValue> * && rec)
{
    constexpr std::size_t max_allocation = basic::error::id::
        Record<TErrorCodeValue, TErrorSystemCategoryValue, 
...
using VariableTestIdentification = basic::test::Variable<
    ...
    basic::test::Value<typename basic::error::defn::type::id::
        Record::ErrorType *>,
    basic::test::Value<typename basic::error::defn::type::id::
        Record::ErrorSystemType *>,
    basic::test::Value<basic::error::defn::type::id::Record *>,
    basic::test::Value<const char *>,
    ...
    basic::test::type::Function<basic::test::CString<char>(
        typename basic::error::defn::type::id::Record::ErrorSystemType * &&), 
        &ErrorSystemToString>,
    basic::test::type::Function<basic::test::CString<char>(basic::error::defn::
...
public:
            ...
            TVariables...>(*this, var...)
    {
        ...
        SetFormat(debug, testAliasRecordType, "Test alias type "
            "%s::RecordType {%s} is same with %s\n");
        SetFormat(error, testAliasRecordType, "Error alias type "
        ...
        SetFormat(debug, testAliasErrorType, "Test alias type "
            "%s::ErrorType {%s} is same with %s\n");
        SetFormat(error, testAliasErrorType, "Error alias type "
        ...
        SetFormat(debug, testAliasErrorSystemType, "Test alias type "
            "%s::ErrorSystemType {%s} is same with %s\n");
        SetFormat(error, testAliasErrorSystemType, "Error alias type "
        ...
        SetFormat(debug, testValueIsDefault, "Test return value "
            "%s::IsDefault() {%s} is same with %s\n");
        SetFormat(error, testValueIsDefault, "Error return value "
        ...
        SetFormat(debug, testValueIsBad, "Test return value "
            "%s::IsBad() {%s} is same with %s\n");
        SetFormat(error, testValueIsBad, "Error return value "
        ...
        SetFormat(debug, testValueIsStandard, "Test return value "
            "%s::IsStandard() {%s} is same with %s\n");
        SetFormat(error, testValueIsStandard, "Error return value "
        ...
        SetFormat(debug, testValueIsCatch, "Test return value "
            "%s::IsCatch() {%s} is same with %s\n");
        SetFormat(error, testValueIsCatch, "Error return value "
        ...
        SetFormat(debug, testValueIsSystem, "Test return value "
            "%s::IsSystem() {%s} is same with %s\n");
        SetFormat(error, testValueIsSystem, "Error return value "
        ...
        SetFormat(debug, testValueFlag, "Test return value "
            "%s::Flag() {%s} is same with %s {%s}\n");
        SetFormat(error, testValueFlag, "Error return value "
        ...
        SetFormat(debug, testValueError, "Test return value "
            "%s::Error() {%s} is same with %s {%s}\n");
        SetFormat(error, testValueError, "Error return value "
        ...
        SetFormat(debug, testValueCastRecord, "Test cast from "
            "%s {%s} to %s is same with %s\n");
        SetFormat(error, testValueCastRecord, "Error cast from "
    ...
    {
        return typeid(typename basic::error::Identification::RecordType).
            hash_code() == typeid(basic::error::defn::type::id::
            Record).hash_code();
    }
    bool Result(const TestAliasErrorType &, VariableTestIdentification & var)
    {
        return typeid(typename basic::error::Identification::ErrorType).
            hash_code() == typeid(typename basic::error::defn::type::id::
            Record::ErrorType).hash_code();
    }
    bool Result(const TestAliasErrorSystemType &, 
        VariableTestIdentification & var)
    {
        return typeid(typename basic::error::Identification::ErrorSystemType).
            hash_code() == typeid(typename basic::error::defn::type::id::
    ...
    bool Result(const TestValueCastRecord &, VariableTestIdentification & var)
    {
        ...
        std::size_t rec_block_size = basic::error::id::rec::
            ToBytes(rec, rec_block, max_alloc);
        std::size_t rec_other_block_size = basic::error::id::rec::
...
constexpr typename basic::error::Identification::CodeValueType
    error_code_value1 = 4;

basic::error::id::Flag flag2_1{basic::error::id::flag::Error{}};
basic::error::id::Flag flag2_2{basic::error::id::flag::Error{},
    basic::error::id::flag::Standard{}};
basic::error::id::Flag flag2_3{basic::error::id::flag::Catch{}};
basic::error::id::Flag flag2_4{basic::error::id::flag::Catch{},
    basic::error::id::flag::Standard{}};

typename basic::error::Identification::ErrorType error2{error_code_value1};

typename basic::error::Identification::RecordType record2_1{flag2_1,
    error_code_value1};
typename basic::error::Identification::RecordType record2_2{flag2_2,
    error_code_value1};
typename basic::error::Identification::RecordType record2_3{flag2_3,
    error_code_value1};
typename basic::error::Identification::RecordType record2_4{flag2_4,
    error_code_value1};

basic::error::Identification obj2_1{error_code_value1};
basic::error::Identification obj2_2{basic::error::id::flag::Standard{},
    error_code_value1};
basic::error::Identification obj2_3{basic::error::id::flag::Catch{}, 
    error_code_value1};
basic::error::Identification obj2_4{basic::error::id::flag::Catch{}, 
    basic::error::id::flag::Standard{}, error_code_value1};
basic::error::Identification obj2_5{basic::error::id::flag::Catch{}, obj2_1};
basic::error::Identification obj2_6{basic::error::id::flag::Catch{}, obj2_2};
basic::error::Identification obj2_7{basic::error::id::flag::Catch{}, 
    basic::error::id::flag::Standard{}, obj2_1};

T1Var1 t2_var1{"obj2_1", &obj2_1, false, false, false, false, false, &flag2_1, 
    &error2, nullptr, &record2_1, "0x000004"};
T1Var1 t2_var2{"obj2_2", &obj2_2, false, false, true, false, false, &flag2_2, 
    &error2, nullptr, &record2_2, "0x040004"};
T1Var1 t2_var3{"obj2_3", &obj2_3, false, false, false, true, false, &flag2_3, 
    &error2, nullptr, &record2_3, "0x080004"};
T1Var1 t2_var4{"obj2_4", &obj2_4, false, false, true, true, false, &flag2_4, 
    &error2, nullptr, &record2_4, "0x0C0004"};
...
basic::error::id::Flag flag3_2{basic::error::id::flag::System{},
    basic::error::id::flag::Standard{}};
basic::error::id::Flag flag3_3{basic::error::id::flag::Catch{}, 
...
basic::error::Identification obj4_1{obj2_1};
basic::error::Identification obj4_2{obj2_2};
basic::error::Identification obj4_3{obj2_3};
basic::error::Identification obj4_4{obj2_4};
basic::error::Identification obj4_5{obj2_5};
basic::error::Identification obj4_6{obj2_6};
basic::error::Identification obj4_7{obj2_7};
...
basic::error::Identification obj5_1{obj3_1};
basic::error::Identification obj5_2{obj3_2};
basic::error::Identification obj5_3{obj3_3};
basic::error::Identification obj5_4{obj3_4};
basic::error::Identification obj5_5{obj3_5};
basic::error::Identification obj5_6{obj3_6};
...
basic::error::Identification obj4_1_c{obj4_1};
basic::error::Identification obj4_2_c{obj4_2};
basic::error::Identification obj4_3_c{obj4_3};
basic::error::Identification obj4_4_c{obj4_4};
basic::error::Identification obj4_5_c{obj4_5};
basic::error::Identification obj4_6_c{obj4_6};
basic::error::Identification obj4_7_c{obj4_7};

basic::error::Identification obj6_1{std::move(obj4_1_c)};
basic::error::Identification obj6_2{std::move(obj4_2_c)};
basic::error::Identification obj6_3{std::move(obj4_3_c)};
basic::error::Identification obj6_4{std::move(obj4_4_c)};
basic::error::Identification obj6_5{std::move(obj4_5_c)};
basic::error::Identification obj6_6{std::move(obj4_6_c)};
basic::error::Identification obj6_7{std::move(obj4_7_c)};
...
T1Var1 t6_var8{"obj4_1_c", &obj4_1_c, true, false, false, false, false, 
    &flag1, &error1, nullptr, &record1, "0x01"};
...
basic::error::Identification obj5_1_c{obj5_1};
basic::error::Identification obj5_2_c{obj5_2};
basic::error::Identification obj5_3_c{obj5_3};
basic::error::Identification obj5_4_c{obj5_4};
basic::error::Identification obj5_5_c{obj5_5};
basic::error::Identification obj5_6_c{obj5_6};
basic::error::Identification obj5_7_c{obj5_7};

basic::error::Identification obj7_1{std::move(obj5_1_c)};
basic::error::Identification obj7_2{std::move(obj5_2_c)};
basic::error::Identification obj7_3{std::move(obj5_3_c)};
basic::error::Identification obj7_4{std::move(obj5_4_c)};
basic::error::Identification obj7_5{std::move(obj5_5_c)};
basic::error::Identification obj7_6{std::move(obj5_6_c)};
