...
using VariableTestStringValue = basic::test::Variable<
    ...
    basic::test::Value<const basic::error::defn::type::Char *>,
...
public:
        ...
        VariableTestStringValue<TStorage> & var)
    {
        ...
        const basic::error::defn::type::Char * value = 
            basic::test::var::At<2>(var).Get().Get();
        auto get = basic::error::msg::str::Value(storage);
