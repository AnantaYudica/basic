...
public:
            ...
            TVariables...>(*this, var...)
    {
        ...
        SetFormat(debug, testValueMove, "test Move "
            "%s with %s {\"%s\"} pass\n");
        SetFormat(error, testValueMove, "Error Move "
            "%s with %s {\"%s\"}\n");
        ...
        SetFormat(debug, testMoveVariableDefault, "test source variable "
            "become default {%s}\n");
        SetFormat(error, testMoveVariableDefault, "Error source variable "
        ...
        TMoveVar, TDefault> & var)
    {
        ...
        basic::error::msg::str::Move(storage, std::move(other));
