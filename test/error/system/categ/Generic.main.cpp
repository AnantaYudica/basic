...
#include "error/system/categ/Generic.h"
...
#include "error/system/tmpl/categ/defn/type/code/set/Value.h"
#include "error/system/tmpl/categ/defn/type/condition/set/Value.h"

#include "error/system/tmpl/categ/has/mmbr/defn/type/CodeEnum.h"
#include "error/system/tmpl/categ/has/mmbr/defn/type/ConditionEnum.h"
#include "error/system/tmpl/categ/has/mmbr/func/DefaultCode.h"
#include "error/system/tmpl/categ/has/mmbr/func/DefaultCodeValue.h"
#include "error/system/tmpl/categ/has/mmbr/func/DefaultCondition.h"
#include "error/system/tmpl/categ/has/mmbr/func/DefaultConditionValue.h"
#include "error/system/tmpl/categ/has/mmbr/func/Equivalent.h"
#include "error/system/tmpl/categ/has/mmbr/func/Message.h"
#include "error/system/tmpl/categ/has/mmbr/func/Name.h"
#include "error/system/tmpl/categ/has/mmbr/func/ToCodeValue.h"
#include "error/system/tmpl/categ/has/mmbr/func/ToConditionValue.h"
#include "error/system/tmpl/categ/has/mmbr/func/Value.h"

#include "error/system/tmpl/categ/has/st/mmbr/func/Instance.h"
...
char DefnCodeTypeString_1[] = "basic::error::system::tmpl::"
    "categ::defn::type::code::set::Value<basic::error::system::categ::"
    "Generic>";
char DefnConditionTypeString_1[] = "basic::error::system::tmpl::"
    "categ::defn::type::condition::set::Value<basic::error::system::"
    "categ::Generic>";
...
typedef basic::error::system::categ::Generic CategoryTraitType;
...
typedef basic::error::defn::type::system::categ::Value CategoryValueType;
...
typedef basic::test::type::Parameter<
    basic::error::system::tmpl::categ::has::mmbr::func::Equivalent<
...
typedef basic::test::type::Parameter<
    basic::error::system::tmpl::categ::has::mmbr::func::Message<
...
typedef basic::test::type::Parameter<
    basic::error::system::tmpl::categ::has::mmbr::func::Name<
        CategoryTraitType>> HasMmbrFuncNameParamTypeType;
typedef basic::test::val::Sequence<bool, 1> 
    HasMmbrFuncNameSeqValueType;
typedef basic::test::type::Parameter<
    basic::error::system::tmpl::categ::has::mmbr::func::ToCodeValue<
        CategoryTraitType, std::errc>> 
...
typedef basic::test::type::Parameter<
    basic::error::system::tmpl::categ::has::mmbr::func::Value<
        CategoryTraitType, CategoryValueType>> HasMmbrFuncValueParamTypeType;
typedef basic::test::val::Sequence<bool, 1> 
    HasMmbrFuncValueSeqValueType;
typedef basic::test::type::Parameter<
    basic::error::system::tmpl::categ::has::st::mmbr::func::Instance<
...
using VariableTestCategoryGeneric = basic::test::Variable<
    CategoryTraitType,
    CodeEnumType,
    ConditionEnumType,
    CharType,
...
constexpr std::size_t IGenericType = 0;
...
typedef basic::test::msg::Argument<TestAliasCodeEnumType,
    ArgTypeName<IGenericType>, ArgTypeName<ICodeEnumType>> 
...
typedef basic::test::msg::Argument<TestAliasConditionEnumType,
    ArgTypeName<IGenericType>, ArgTypeName<IConditionEnumType>> 
...
typedef basic::test::msg::Argument<TestAliasCharType,
    ArgTypeName<IGenericType>, ArgTypeName<ICharType>> 
...
typedef basic::test::msg::Argument<TestAliasCategoryValueType,
    ArgTypeName<IGenericType>, ArgTypeName<ICategoryValueType>> 
...
typedef basic::test::msg::Argument<TestAliasStringType,
    ArgTypeName<IGenericType>, ArgTypeName<IStringType>> 
...
struct TestCategoryGeneric :
    public basic::test::Message<BASIC_TEST, TestCategoryGeneric<TCases, 
        TVariables...>>,
    public basic::test::Case<TestCategoryGeneric<TCases, TVariables...>,
        TCases>,
    public basic::test::Base<TestCategoryGeneric<TCases, TVariables...>, 
        TVariables...>,
...
{
public:
    using basic::test::Case<TestCategoryGeneric<TCases, TVariables...>,
        TCases>::Run;
    using basic::test::Base<TestCategoryGeneric<TCases, TVariables...>, 
        TVariables...>::Run;
...
public:
    TestCategoryGeneric(TVariables & ... var) :
        basic::test::Message<BASIC_TEST, TestCategoryGeneric<TCases, 
            TVariables...>>(*this),
        basic::test::Case<TestCategoryGeneric<TCases, TVariables...>,
            TCases>(*this),
        basic::test::Base<TestCategoryGeneric<TCases, TVariables...>, 
            TVariables...>(*this, var...)
    {
    ...
    bool Result(const TestAliasCodeEnumType &, 
        VariableTestCategoryGeneric & var)
    {
    ...
    bool Result(const TestAliasCharType &, VariableTestCategoryGeneric & var)
    {
    ...
    bool Result(const TestValueName &, VariableTestCategoryGeneric & var)
    {
        auto & result = basic::test::var::At<INameValue>(var).Get().Get();
        return strcmp(CategoryTraitType::Instance().Name(), result) == 0;
    }
    bool Result(const TestValueValue &, VariableTestCategoryGeneric & var)
    {
        ...
        VariableTestCategoryGeneric & var)
    {
        typedef typename basic::test::var::Element<
            ...
            VariableTestCategoryGeneric>::Type ParamType;
        typedef typename basic::test::type::param::Element<I, 
            ParamType>::Type ResultType;
        return typeid(typename basic::error::system::tmpl::categ::defn::
...
typedef VariableTestCategoryGeneric T1Var1;
...
CategoryValueType categ_val{basic::constant::error::system::generic_category};
...
T1Var1 t1_var1{
    ...
    std::generic_category().name(), categ_val, 
    true, true, 
    false, 
    false, 
    true,
...
REGISTER_TEST(t1, new TestCategoryGeneric<Case1, T1Var1>(t1_var1));
...
BASIC_TEST_TYPE_NAME("basic::error::system::categ::Generic",
    basic::error::system::categ::Generic);
...
struct basic::test::type::Name<basic::error::system::tmpl::categ::has::
    mmbr::defn::type::CodeEnum<TArg>>
{
    static basic::test::CString<char> CStr()
    {
        static char _format[] = "basic::error::system::tmpl::categ::has::"
...
struct basic::test::type::Name<
    basic::error::system::tmpl::categ::has::mmbr::func::DefaultCode<TArg1,
        TArg2, TArg3>>
{
    static basic::test::CString<char> CStr()
    {
        ...
        DefaultCondition<TArg1, TArg2, TArg3, TArg4>>
{
    static basic::test::CString<char> CStr()
    {
        static char _format[] = "asic::error::system::tmpl::categ::has::"
...
template<typename TArg1, typename TArg2, typename TArg3>
struct basic::test::type::Name<
    basic::error::system::tmpl::categ::has::mmbr::func::Equivalent<TArg1,
        TArg2, TArg3>>
{
    static basic::test::CString<char> CStr()
    {
...
template<typename TArg1, typename TArg2, typename TArg3>
struct basic::test::type::Name<
    basic::error::system::tmpl::categ::has::mmbr::func::Message<TArg1,
        TArg2, TArg3>>
{
    static basic::test::CString<char> CStr()
    {
