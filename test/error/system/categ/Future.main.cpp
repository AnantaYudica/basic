...
#include "error/system/categ/Future.h"
...
typedef basic::error::system::categ::Future CategoryTraitType;
...
CategoryValueType categ_val{basic::constant::error::system::future_category};
...
BASIC_TEST_TYPE_NAME("basic::error::system::categ::Future",
    basic::error::system::categ::Future);
