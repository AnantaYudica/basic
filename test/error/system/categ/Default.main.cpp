...
#include "error/system/categ/Default.h"
...
typedef basic::error::system::categ::Default CategoryTraitType;
...
CategoryValueType categ_val{basic::constant::error::system::system_category};
...
BASIC_TEST_TYPE_NAME("basic::error::system::categ::Default",
    basic::error::system::categ::Default);
