...
#include "error/system/category/Future.h"
...
typedef basic::error::system::category::Future CategoryTraitType;
...
CategoryValueType category_val{basic::constant::error::system::future_category};
...
T1Var1 t1_var1{
    ...
    std::future_category().name(), category_val, 
    true, true, 
    false, 
    false, 
    true,
...
BASIC_TEST_TYPE_NAME("basic::error::system::category::Future",
    basic::error::system::category::Future);
