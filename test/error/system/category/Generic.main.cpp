...
#include "error/system/category/Generic.h"
...
typedef basic::error::system::category::Generic CategoryTraitType;
...
CategoryValueType category_val{basic::constant::error::system::generic_category};
...
T1Var1 t1_var1{
    ...
    std::generic_category().name(), category_val, 
    true, true, 
    false, 
    false, 
    true,
...
BASIC_TEST_TYPE_NAME("basic::error::system::category::Generic",
    basic::error::system::category::Generic);
