#ifndef BASIC_CSTR_FIND_FIRSTOF_H_
#define BASIC_CSTR_FIND_FIRSTOF_H_
...
TSize FirstOf<TChar, TCharTrait>::Position(const cstr::Element<const TChar, 
...
#endif //!BASIC_CSTR_FIND_FIRSTOF_H_
