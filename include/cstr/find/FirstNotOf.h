#ifndef BASIC_CSTR_FIND_FIRSTNOTOF_H_
#define BASIC_CSTR_FIND_FIRSTNOTOF_H_
...
TSize FirstNotOf<TChar, TCharTrait>::Position(const cstr::Element<const TChar, 
...
#endif //!BASIC_CSTR_FIND_FIRSTNOTOF_H_
