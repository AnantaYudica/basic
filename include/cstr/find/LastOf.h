#ifndef BASIC_CSTR_FIND_LASTOF_H_
#define BASIC_CSTR_FIND_LASTOF_H_
...
TSize LastOf<TChar, TCharTrait>::Position(const cstr::Element<const TChar, 
...
#endif //!BASIC_CSTR_FIND_LASTOF_H_
