#ifndef BASIC_ERROR_SYSTEM_TMPL_CATEG_DEFN_TYPE_CODE_SET_VALUE_H_
#define BASIC_ERROR_SYSTEM_TMPL_CATEG_DEFN_TYPE_CODE_SET_VALUE_H_
...
#endif //!BASIC_ERROR_SYSTEM_TMPL_CATEG_DEFN_TYPE_CODE_SET_VALUE_H_
