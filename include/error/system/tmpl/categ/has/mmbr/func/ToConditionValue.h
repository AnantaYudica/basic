#ifndef BASIC_ERROR_SYSTEM_TMPL_CATEG_HAS_MMBR_FUNC_TOCONDITIONVALUE_H_
#define BASIC_ERROR_SYSTEM_TMPL_CATEG_HAS_MMBR_FUNC_TOCONDITIONVALUE_H_
...
using ToConditionValue = _helper::_basic::_error::_system::_tmpl::_categ::
    _has::_mmbr::_func::_ToConditionValue<TCategoryTrait, 
    error::defn::type::system::condition::Value, TConditionEnum>;
...
#endif //!BASIC_ERROR_SYSTEM_TMPL_CATEG_HAS_MMBR_FUNC_TOCONDITIONVALUE_H_
