#ifndef BASIC_ERROR_SYSTEM_TMPL_CATEG_HAS_MMBR_FUNC_DEFAULTCONDITION_H_
#define BASIC_ERROR_SYSTEM_TMPL_CATEG_HAS_MMBR_FUNC_DEFAULTCONDITION_H_
...
template<typename TCategoryTrait, typename TCondition, typename TCode,
    typename TCategory>
using DefaultCondition = _helper::_basic::_error::_system::_tmpl::_categ::
...
#endif //!BASIC_ERROR_SYSTEM_TMPL_CATEG_HAS_MMBR_FUNC_DEFAULTCONDITION_H_
