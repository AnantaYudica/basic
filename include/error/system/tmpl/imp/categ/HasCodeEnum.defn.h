#ifndef BASIC_ERROR_SYSTEM_TMPL_IMP_CATEG_HASCODEENUM_H_DEFN_
#define BASIC_ERROR_SYSTEM_TMPL_IMP_CATEG_HASCODEENUM_H_DEFN_
...
#endif //!BASIC_ERROR_SYSTEM_TMPL_IMP_CATEG_HASCODEENUM_H_DEFN_
