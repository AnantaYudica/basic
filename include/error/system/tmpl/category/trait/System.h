#ifndef BASIC_ERROR_SYSTEM_TMPL_CATEGORY_TRAIT_SYSTEM_H_
#define BASIC_ERROR_SYSTEM_TMPL_CATEGORY_TRAIT_SYSTEM_H_
...
#endif //!BASIC_ERROR_SYSTEM_TMPL_CATEGORY_TRAIT_SYSTEM_H_