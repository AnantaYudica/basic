#ifndef BASIC_ERROR_SYS_TMPL_IMP_CATEG_HASCODEENUM_H_
#define BASIC_ERROR_SYS_TMPL_IMP_CATEG_HASCODEENUM_H_
...
#endif //!BASIC_ERROR_SYS_TMPL_IMP_CATEG_HASCODEENUM_H_
