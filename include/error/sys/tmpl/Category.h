#ifndef BASIC_ERROR_SYS_TMPL_CATEGORY_H_
#define BASIC_ERROR_SYS_TMPL_CATEGORY_H_
...
bool operator==(const basic::error::sys::tmpl::
    Category<TCategoryTraitA>& categ_a, const basic::error::sys::tmpl::
...
#endif //!BASIC_ERROR_SYS_TMPL_CATEGORY_H_