#ifndef BASIC_ERROR_SYS_TMPL_CATEG_DEFN_TYPE_CODE_SET_VALUE_H_
#define BASIC_ERROR_SYS_TMPL_CATEG_DEFN_TYPE_CODE_SET_VALUE_H_
...
struct _Value
{
    typedef basic::error::defn::type::sys::code::Value Type;
};
...
#endif //!BASIC_ERROR_SYS_TMPL_CATEG_DEFN_TYPE_CODE_SET_VALUE_H_
