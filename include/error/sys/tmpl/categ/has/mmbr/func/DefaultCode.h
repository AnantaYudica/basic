#ifndef BASIC_ERROR_SYS_TMPL_CATEG_HAS_MMBR_FUNC_DEFAULTCODE_H_
#define BASIC_ERROR_SYS_TMPL_CATEG_HAS_MMBR_FUNC_DEFAULTCODE_H_
...
template<typename TCategoryTrait, typename TCode, 
    typename TCategory>
using DefaultCode = _helper::_basic::_error::_sys::_tmpl::_categ::
...
#endif //!BASIC_ERROR_SYS_TMPL_CATEG_HAS_MMBR_FUNC_DEFAULTCODE_H_
