#ifndef BASIC_ERROR_SYS_TMPL_CATEG_HAS_MMBR_FUNC_TOCODEVALUE_H_
#define BASIC_ERROR_SYS_TMPL_CATEG_HAS_MMBR_FUNC_TOCODEVALUE_H_
...
using ToCodeValue = _helper::_basic::_error::_sys::_tmpl::_categ::
    _has::_mmbr::_func::_ToCodeValue<TCategoryTrait, 
    error::defn::type::sys::code::Value, TCodeEnum>;
...
#endif //!BASIC_ERROR_SYS_TMPL_CATEG_HAS_MMBR_FUNC_TOCODEVALUE_H_
