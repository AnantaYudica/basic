#ifndef BASIC_ERROR_SYS_TMPL_CATEG_HAS_MMBR_FUNC_EQUIVALENT_H_
#define BASIC_ERROR_SYS_TMPL_CATEG_HAS_MMBR_FUNC_EQUIVALENT_H_
...
using Equivalent = _helper::_basic::_error::_sys::_tmpl::_categ::
...
#endif //!BASIC_ERROR_SYS_TMPL_CATEG_HAS_MMBR_FUNC_EQUIVALENT_H_
