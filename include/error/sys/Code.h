#ifndef BASIC_ERROR_SYS_CODE_H_
#define BASIC_ERROR_SYS_CODE_H_
...
inline bool operator==(const basic::error::sys::Code & code_a, 
    const basic::error::sys::Code & code_b) noexcept
{
...
inline bool operator==(const basic::error::sys::Code & code_a, 
    const basic::error::defn::type::sys::code::Value & code_b) noexcept
{
    return code_a.Value() == code_b;
}

template<typename TCodeEnum>
inline typename std::enable_if<basic::error::sys::code::has::
    Enum<TCodeEnum>::Value, bool>::type 
operator==(const basic::error::sys::Code & code_a, 
    const TCodeEnum & code_b) noexcept
{
    return code_a.Category() == basic::error::sys::make::Category(code_b) &&
        code_a.Value() == basic::error::sys::make::code::Value(code_b);
}

inline bool operator==(const basic::error::defn::type::sys::code::
    Value & code_a, const basic::error::sys::Code & code_b) noexcept
{
...
inline typename std::enable_if<basic::error::sys::code::has::
    Enum<TCodeEnum>::Value, bool>::type 
operator==(const basic::error::defn::type::sys::code::Value & code_a, 
    const TCodeEnum & code_b) noexcept
{
    return code_a == basic::error::sys::make::code::Value(code_b);
}
...
operator<(const TCodeEnum & code_a, 
    const basic::error::sys::Code & code_b) noexcept
{
    return basic::error::sys::make::Category(code_a) == code_b.Category() &&
        basic::error::sys::make::code::Value(code_a) < code_b.Value();
}
...
operator<(const TCodeEnum & code_a, 
    const basic::error::defn::type::sys::code::Value & code_b) noexcept
{
    return basic::error::sys::make::code::Value(code_a) < code_b;
}
