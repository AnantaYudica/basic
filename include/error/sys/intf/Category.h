#ifndef BASIC_ERROR_SYS_INTF_CATEGORY_H_
#define BASIC_ERROR_SYS_INTF_CATEGORY_H_
...
bool operator==(const basic::error::sys::intf::Category & a, 
    const basic::error::sys::intf::Category & b) noexcept
{
...
#endif //!BASIC_ERROR_SYS_INTF_CATEGORY_H_