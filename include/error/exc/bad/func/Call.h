#ifndef BASIC_ERROR_EXC_BAD_FUNC_CALL_H_
#define BASIC_ERROR_EXC_BAD_FUNC_CALL_H_
...
class Call : public error::exc::bad::Function
{
public:
...
inline const error::intf::Output & Call::
    operator>>(OutputType & out) const noexcept
{
    error::exc::bad::Function::operator>>(out);
    return *this;
}
...
#endif //!BASIC_ERROR_EXC_BAD_FUNC_CALL_H_
