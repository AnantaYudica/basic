...
#define __DEFINE_MMBR_FUNC_TMPL_ARG_LIST_(\
    __T_DEFN__,\
    __T_RET_NAME__,\
    __T_ARGS_NAME__)\
__T_DEFN__, __T_RET_NAME__, __T_ARGS_NAME__...
...
#define __DEFINE_MMBR_FUNC_TMPL_ARG_PRIMARY_(...)

#define __DEFINE_MMBR_FUNC_TMPL_ARG_SPECIALIZED_(\
    __T_DEFN__,\
    __T_RET_NAME__,\
    __T_ARGS_NAME__,\
    __TMPL_ARG_LIST_POSTFIX__)\
<__DEFINE_MMBR_FUNC_TMPL_ARG_LIST_##__TMPL_ARG_LIST_POSTFIX__(__T_DEFN__,\
    __T_RET_NAME__, __T_ARGS_NAME__)>

#define __DEFINE_MMBR_FUNC_STATIC_ASSERT_PRIMARY_(...)

#define __DEFINE_MMBR_FUNC_STATIC_ASSERT_SPECIALIZED_(\
    __T_NAME__,\
    __T_NAME_OR_T_NAME_TMPL__,\
    __T_NAME_TMPL_ARG_LIST_POSTFIX__)\
static_assert(\
...
template<__DEFINE_MMBR_FUNC_TMPL_PARAM_LIST_\
    ##__TMPL_PARAM_LIST_POSTFIX__(__T_NAME__, __T_RET_NAME__,\
        __T_ARGS_NAME__)>\
struct __STRUCT_NAME__ __DEFINE_MMBR_FUNC_TMPL_ARG_\
    ##__PRIMARY_OR_SPECIALIZED__(__T_DEFN__, __T_RET_NAME__,\
        __T_ARGS_NAME__, __TMPL_ARG_LIST_POSTFIX__)\
{\
    __DEFINE_MMBR_FUNC_STATIC_ASSERT_##__PRIMARY_OR_SPECIALIZED__(\
...
__DEFINE_MMBR_FUNC_STRUCT_(__STRUCT_NAME__, __T_NAME__, __T_RET_NAME__,\
    __T_ARGS_NAME__,,, __TMPL_PARAM_LIST_POSTFIX__, PRIMARY_,\
    __TMPL_ARG_LIST_POSTFIX__, __T_NAME_OR_T_NAME_TMPL__,\
    __T_NAME_TMPL_ARG_LIST_POSTFIX__, __T_RET_NAME_OR_T_RET_NAME_TMPL__,\
    __T_RET_NAME_TMPL_ARG_LIST_POSTFIX__, __ALIAS_TYPE_OR_ALIAS_TYPE_TMPL__,\
    __ALIAS_TMPL_TYPE_PARAM_LIST_POSTFIX__, __PTR_OR_PTR_TMPL__,\
    __PTR_TMPL_PARAM_LIST_POSTFIX__, __PTR_RET_OR_PTR_RET_TMPL__,\
    __PTR_RET_TMPL_ARG_LIST_POSTFIX__, __MMBR_FUNC_NAME__,##__VA_ARGS__);\
__DEFINE_MMBR_FUNC_STRUCT_(__STRUCT_NAME__, __T_NAME__, __T_RET_NAME__,\
    __T_ARGS_NAME__, const __T_NAME__, const, __TMPL_PARAM_LIST_POSTFIX__,\
    SPECIALIZED_, __TMPL_ARG_LIST_POSTFIX__, __T_NAME_OR_T_NAME_TMPL__,\
    __T_NAME_TMPL_ARG_LIST_POSTFIX__, __T_RET_NAME_OR_T_RET_NAME_TMPL__,\
    __T_RET_NAME_TMPL_ARG_LIST_POSTFIX__, __ALIAS_TYPE_OR_ALIAS_TYPE_TMPL__,\
    __ALIAS_TMPL_TYPE_PARAM_LIST_POSTFIX__, __PTR_OR_PTR_TMPL__,\
    __PTR_TMPL_PARAM_LIST_POSTFIX__, __PTR_RET_OR_PTR_RET_TMPL__,\
    __PTR_RET_TMPL_ARG_LIST_POSTFIX__, __MMBR_FUNC_NAME__,##__VA_ARGS__);\
__DEFINE_MMBR_FUNC_STRUCT_(__STRUCT_NAME__, __T_NAME__, __T_RET_NAME__,\
    __T_ARGS_NAME__, volatile __T_NAME__, volatile,\
    __TMPL_PARAM_LIST_POSTFIX__, SPECIALIZED_, __TMPL_ARG_LIST_POSTFIX__,\
    __T_NAME_OR_T_NAME_TMPL__, __T_NAME_TMPL_ARG_LIST_POSTFIX__,\
    ...
    __MMBR_FUNC_NAME__,##__VA_ARGS__);\
__DEFINE_MMBR_FUNC_STRUCT_(__STRUCT_NAME__, __T_NAME__, __T_RET_NAME__,\
    __T_ARGS_NAME__, const volatile __T_NAME__, const volatile,\
    __TMPL_PARAM_LIST_POSTFIX__, SPECIALIZED_, __TMPL_ARG_LIST_POSTFIX__,\
    __T_NAME_OR_T_NAME_TMPL__, __T_NAME_TMPL_ARG_LIST_POSTFIX__,\
    __T_RET_NAME_OR_T_RET_NAME_TMPL__, __T_RET_NAME_TMPL_ARG_LIST_POSTFIX__,\
    __ALIAS_TYPE_OR_ALIAS_TYPE_TMPL__, __ALIAS_TMPL_TYPE_PARAM_LIST_POSTFIX__,\
    ...
    __MMBR_FUNC_NAME__,##__VA_ARGS__);\
__DEFINE_MMBR_FUNC_STRUCT_(__STRUCT_NAME__, __T_NAME__, __T_RET_NAME__,\
    __T_ARGS_NAME__, __T_NAME__&, &, __TMPL_PARAM_LIST_POSTFIX__,\
    SPECIALIZED_, __TMPL_ARG_LIST_POSTFIX__, __T_NAME_OR_T_NAME_TMPL__,\
    __T_NAME_TMPL_ARG_LIST_POSTFIX__, __T_RET_NAME_OR_T_RET_NAME_TMPL__,\
    __T_RET_NAME_TMPL_ARG_LIST_POSTFIX__, __ALIAS_TYPE_OR_ALIAS_TYPE_TMPL__,\
    __ALIAS_TMPL_TYPE_PARAM_LIST_POSTFIX__, __PTR_OR_PTR_TMPL__,\
...
__DEFINE_MMBR_FUNC_STRUCT_(__STRUCT_NAME__, __T_NAME__, __T_RET_NAME__,\
    ...
    __PTR_RET_TMPL_ARG_LIST_POSTFIX__, __MMBR_FUNC_NAME__,##__VA_ARGS__);\
__DEFINE_MMBR_FUNC_STRUCT_(__STRUCT_NAME__, __T_NAME__, __T_RET_NAME__,\
    __T_ARGS_NAME__, const __T_NAME__ &&, const &&,\
    __TMPL_PARAM_LIST_POSTFIX__, SPECIALIZED_, __TMPL_ARG_LIST_POSTFIX__,\
    __T_NAME_OR_T_NAME_TMPL__, __T_NAME_TMPL_ARG_LIST_POSTFIX__,\
    __T_RET_NAME_OR_T_RET_NAME_TMPL__, __T_RET_NAME_TMPL_ARG_LIST_POSTFIX__,\
    __ALIAS_TYPE_OR_ALIAS_TYPE_TMPL__, __ALIAS_TMPL_TYPE_PARAM_LIST_POSTFIX__,\
...
#define __DEFINE_MMBR_FUNC_DEFAULT_(__STRUCT_NAME__, __T_NAME__,\
    __T_RET_NAME__, __T_ARGS_NAME__, __MMBR_FUNC_NAME__, ...)\
