#ifndef BASIC_MACRO_HASOBJECTMEMBER_H_
#define BASIC_MACRO_HASOBJECTMEMBER_H_
...
__T_NAME__<__DEFINE_HAS_MMBR_OBJ_T_NAME_TMPL_ARG_LIST_\
    ##__T_NAME_TMPL_ARG_LIST_POSTFIX__()>
...
#endif //!BASIC_MACRO_HASOBJECTMEMBER_H_
