...
::__DEFINE_CONDITIONAL_T_TRUE_DEFN_TYPE_MMBR_NAME_\
	##__T_TRUE_DEFN_TYPE_MMBR_NAME_POSTFIX__()

#define __DEFINE_CONDITIONAL_T_FALSE_DEFN_TYPE_MMBR_(\
	__T_FALSE_DEFN_TYPE_MMBR_NAME_POSTFIX__)\
::__DEFINE_CONDITIONAL_T_FALSE_DEFN_TYPE_MMBR_NAME_\
	##__T_FALSE_DEFN_TYPE_MMBR_NAME_POSTFIX__()
...
#define __DEFINE_CONDITIONAL_ALIAS_TYPE_TRUE_(\
	...
	__T__TRUE_OR_FALSE__DEFN_TYPE_MMBR_NAME_POSTFIX__,\
...
#define __DEFINE_CONDITIONAL_STATIC_ASSERT_TRUE_(\
	__BOOL_CONDITIONAL_NAME__)\
static_assert(__BOOL_CONDITIONAL_NAME__,\
	"false condition not implementation");

#define __DEFINE_CONDITIONAL_STATIC_ASSERT_FALSE_(...)
...
{\
	__DEFINE_CONDITIONAL_STATIC_ASSERT_##__TRUE_OR_FALSE__(\
		__BOOL_CONDITIONAL_NAME__)\
	__DEFINE_CONDITIONAL_\
