...
#define __DEFINE_HAS_MMBR_FUNC_PROTO_FUNC_TRUE_TRAILING_(\
    __VAR_T_NAME__,\
    __VAR_T_ARGS_NAME__,\
    __T_NAME__,\
    __T_RET_NAME__,\
    ...
    __PROTO_FUNC_T_RET_NAME_TMPL_ARG_LIST_POSTFIX__,\
    __MMBR_FUNC_NAME__, ...)\
decltype(((static_cast<__DEFINE_HAS_MMBR_FUNC_\
    ##__PROTO_FUNC_T_NAME_OR_PROTO_FUNC_T_NAME_TMPL__(__T_NAME__,\
        __PROTO_FUNC_T_NAME_TMPL_ARG_LIST_POSTFIX__) __REF_DEFN__>(\
    __VAR_T_NAME__)).*(static_cast<__DEFINE_HAS_MMBR_FUNC_\
        ##__PROTO_FUNC_T_RET_NAME_OR_PROTO_FUNC_T_RET_NAME_TMPL__(\
        __T_RET_NAME__, __PROTO_FUNC_T_RET_NAME_TMPL_ARG_LIST_POSTFIX__) (\
    __DEFINE_HAS_MMBR_FUNC_\
        ##__PROTO_FUNC_T_NAME_OR_PROTO_FUNC_T_NAME_TMPL__(__T_NAME__,\
        __PROTO_FUNC_T_NAME_TMPL_ARG_LIST_POSTFIX__)::*)(\
    __T_ARGS_NAME__...)__CV_DEFN__ __REF_DEFN__>(&__DEFINE_HAS_MMBR_FUNC_\
        ##__PROTO_FUNC_T_NAME_OR_PROTO_FUNC_T_NAME_TMPL__(__T_NAME__,\
        __PROTO_FUNC_T_NAME_TMPL_ARG_LIST_POSTFIX__)::__MMBR_FUNC_NAME__\
...
__DEFINE_HAS_MMBR_FUNC_PROTO_FUNC_TRUE_TRAILING_(t, args,\
    __T_NAME__, __T_RET_NAME__, __T_ARGS_NAME__, __CV_DEFN__, __REF_DEFN__,\
    __PROTO_FUNC_TRUE_TMPL_PARAM_LIST_POSTFIX__,\
    __PROTO_FUNC_T_NAME_OR_PROTO_FUNC_T_NAME_TMPL__,\
    __PROTO_FUNC_T_NAME_TMPL_ARG_LIST_POSTFIX__,\
    __PROTO_FUNC_T_RET_NAME_OR_PROTO_FUNC_T_RET_NAME_TMPL__,\
...
__T_NAME__<__DEFINE_HAS_MMBR_FUNC_T_NAME_TMPL_ARG_LIST_\
    ##__T_NAME_TMPL_ARG_LIST_POSTFIX__()>
...
decltype(__DEFINE_HAS_MMBR_FUNC_PROTO_FUNC_TMPL_(__T_NAME__,\
    ...
    __PROTO_FUNC_TMPL_ARG_LIST__)(\
        __DEFINE_HAS_MMBR_FUNC_PROTO_FUNC_TMPL_ARGS_(__T_NAME__,\
            __T_ARGS_NAME__, __T_NAME_OR_T_NAME_TMPL__,\
            __T_NAME_TMPL_ARG_LIST_POSTFIX__)))
...
__DEFINE_HAS_MMBR_FUNC_PROTO_FUNC_FALSE_(__PROTO_FUNC_NAME__,\
    ...
    __PROTO_FUNC_FALSE_TMPL_PARAM_LIST_POSTFIX__);\
__DEFINE_HAS_MMBR_FUNC_STRUCT_(__STRUCT_NAME__, __PROTO_FUNC_NAME__,\
    __T_NAME__, __T_RET_NAME__, __T_ARGS_NAME__,\
...
#define __DEFINE_HAS_MMBR_FUNC_DEFAULT_(\
    ...
    __REF_DEFN__,\
    ___MMBR_FUNC_NAME__, ...)\
__DEFINE_HAS_MMBR_FUNC_(__STRUCT_NAME__, __PROTO_FUNC_NAME__,\
    __T_NAME__, __T_RET_NAME__, __T_ARGS_NAME__,\
    __CV_DEFN__, __REF_DEFN__,, T_NAME_,,,,, PROTO_FUNC_T_NAME_,,\
    PROTO_FUNC_T_RET_NAME_,, __MMBR_FUNC_NAME__,##__VA_ARGS__)
