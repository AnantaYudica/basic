...
__T_RET_NAME__<__MACRO_DEFINE_NAME_PREFIX__\
    ##PROTO_FUNC_T_RET_NAME_TMPL_ARG_LIST_\
    ##__PROTO_FUNC_T_RET_NAME_TMPL_ARG_LIST_POSTFIX__()>
...
#define __DEFINE_HAS_MMBR_FUNC_(\
    ...
    __PROTO_FUNC_T_RET_NAME_TMPL_ARG_LIST_POSTFIX__,\
    __MMBR_FUNC_NAME__, ...)\
__DEFINE_HAS_MMBR_FUNC_PROTO_FUNC_TRUE_(__LVAL_PROTO_FUNC_NAME__,\
...
__DEFINE_HAS_MMBR_FUNC_PROTO_FUNC_FALSE_(__LVAL_PROTO_FUNC_NAME__,\
    __T_NAME__, __T_RET_NAME__, __T_ARGS_NAME__, __DEFINE_HAS_MMBR_FUNC_,\
    __PROTO_FUNC_FALSE_TMPL_PARAM_LIST_POSTFIX__);\
__DEFINE_HAS_MMBR_FUNC_PROTO_FUNC_TRUE_(__RVAL_PROTO_FUNC_NAME__,\
    __T_NAME__, __T_RET_NAME__, __T_ARGS_NAME__,\
    __DEFINE_HAS_MMBR_FUNC_,\
    __PROTO_FUNC_TRUE_TMPL_PARAM_LIST_POSTFIX__,\
    __PROTO_FUNC_T_NAME_OR_PROTO_FUNC_T_NAME_TMPL__,\
...
__DEFINE_HAS_MMBR_FUNC_PROTO_FUNC_FALSE_(__RVAL_PROTO_FUNC_NAME__,\
    __T_NAME__, __T_RET_NAME__, __T_ARGS_NAME__, __DEFINE_HAS_MMBR_FUNC_,\
    __PROTO_FUNC_FALSE_TMPL_PARAM_LIST_POSTFIX__);\
__DEFINE_HAS_MMBR_FUNC_STRUCT_(__STRUCT_NAME__, __LVAL_PROTO_FUNC_NAME__,\
