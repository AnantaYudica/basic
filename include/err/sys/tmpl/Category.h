#ifndef BASIC_ERR_SYS_TMPL_CATEGORY_H_
#define BASIC_ERR_SYS_TMPL_CATEGORY_H_
...
template<typename TCategoryTrait>
const err::intf::Output & Category<TCategoryTrait>::
...
bool operator==(const basic::err::sys::tmpl::
    Category<TCategoryTraitA>& categ_a, const basic::err::sys::tmpl::
...
#endif //!BASIC_ERR_SYS_TMPL_CATEGORY_H_