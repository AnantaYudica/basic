#ifndef BASIC_ERR_SYS_TMPL_CATEG_HAS_MMBR_FUNC_VALUE_H_
#define BASIC_ERR_SYS_TMPL_CATEG_HAS_MMBR_FUNC_VALUE_H_
...
using Value = _helper::_basic::_err::_sys::_tmpl::_categ::
...
#endif //!BASIC_ERR_SYS_TMPL_CATEG_HAS_MMBR_FUNC_VALUE_H_
