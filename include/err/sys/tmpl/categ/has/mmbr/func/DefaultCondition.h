#ifndef BASIC_ERR_SYS_TMPL_CATEG_HAS_MMBR_FUNC_DEFAULTCONDITION_H_
#define BASIC_ERR_SYS_TMPL_CATEG_HAS_MMBR_FUNC_DEFAULTCONDITION_H_
...
template<typename TCategoryTrait, typename TCondition, typename TCode,
    typename TCategory>
using DefaultCondition = _helper::_basic::_err::_sys::_tmpl::_categ::
...
#endif //!BASIC_ERR_SYS_TMPL_CATEG_HAS_MMBR_FUNC_DEFAULTCONDITION_H_
