#ifndef BASIC_ERR_SYS_CATEG_GENERIC_H_
#define BASIC_ERR_SYS_CATEG_GENERIC_H_
...
{
    return basic::defn::err::sys::generic_category; 
}
...
#endif //!BASIC_ERR_SYS_CATEG_GENERIC_H_