#ifndef BASIC_DEFN_ERR_IDENTIFICATION_H_
#define BASIC_DEFN_ERR_IDENTIFICATION_H_
...
enum : basic::err::defn::type::code::Value
{
    undefined_id = static_cast<basic::err::defn::type::code::Value>(-1),
    exception_id = 1,
    logic_id = 11,
...
#endif //!BASIC_DEFN_ERR_IDENTIFICATION_H_
